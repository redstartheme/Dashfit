...
@Component({
    ...
    imports: [PageHeaderComponent, MatCardModule, BaseChartDirective]
})
    ...
    datasets: [
      {
        ...
        pointRadius: 3,
        pointHoverRadius: 6,
        pointBorderColor: '#199AFB',
        pointBackgroundColor: '#199AFB',
      },
      {
        label: 'Electronics',
        ...
        pointRadius: 3,
        pointHoverRadius: 6,
        pointBorderColor: '#17E49E',
        pointBackgroundColor: '#17E49E',
      },
    ],
